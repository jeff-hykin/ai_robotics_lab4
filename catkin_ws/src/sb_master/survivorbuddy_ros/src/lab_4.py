...
routine.extend([
    { "time":    52.50, "positions": allDo( lean_forward ) },
])
routine.extend([
    { "time":    52.75, "positions": allDo( lean_back ) },
])
routine.extend([
    { "time":    53.00, "positions": allDo( lean_forward ) },
])
routine.extend([
    { "time":    53.25, "positions": allDo( lean_back ) },
])
routine.extend([
    { "time":    53.50, "positions": allDo( lean_forward ) },
])
routine.extend([
    { "time":    53.75, "positions": allDo( lean_back ) },
])
...
routine.extend([
    { "time":    64.75 + t, "positions": delayed_sine_full(time=t, motion=lean_forward, delay=0.25, speed=1) } 
    for t in np.arange(0.25, 4+4*0.25, 0.25)])

routine.extend([
    { "time":    65.00, "positions": allDo( lean_forward )},]) 
routine.extend([
...
routine.extend([
    { "time":    80.00, "positions": allDo( lean_forward )},])
routine.extend([
    { "time":    80.25, "positions": allDo( lean_back )},])
routine.extend([
    { "time":    80.50, "positions": allDo( lean_forward )},])
routine.extend([
    { "time":    80.75, "positions": allDo( lean_back )},])
routine.extend([
    { "time":    81.00, "positions": allDo( lean_forward )},])
routine.extend([
    { "time":    81.25, "positions": allDo( lean_back )},])
routine.extend([
...
routine.extend([
    { "time":    107.25, "positions": allDo(lean_back)},])
routine.extend([
    { "time":    107.50, "positions": allDo(lean_forward)},])
routine.extend([
    { "time":    107.75, "positions": allDo(lean_back)},])
routine.extend([
    { "time":    108.00, "positions": allDo(lean_forward)},])
...
routine.extend([
    { "time":    121.25, "positions": allDo(lean_back)},])
routine.extend([
    { "time":    121.50, "positions": allDo(lean_forward)},])
routine.extend([
    { "time":    121.75, "positions": allDo(lean_back)},])
routine.extend([
    { "time":    122.00, "positions": allDo(lean_forward)},])
routine.extend([
